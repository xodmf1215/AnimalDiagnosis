    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent regactivity = new Intent(SignInActivity.this,SignUpActivity.class);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://106.242.109.54:3000/login",params);
                if(json != null){
                    try{
        ...
        forpass.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                reset = new Dialog(SignInActivity.this);
                reset.setTitle("Reset Password");
                reset.setContentView(R.layout.reset_passinit_dlg);
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("http://106.242.109.54:3000/api/resetpass", params);
                        ...
                        if (json != null) {
                            try {
                                ...
                                if(json.getBoolean("res")){
                                    Log.e("JSON", jsonstr);
                                    Toast.makeText(getApplication(), jsonstr, Toast.LENGTH_LONG).show();
                                    reset.setContentView(R.layout.reset_passcode_dlg);
                                    ...
                                    cont_code.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            JSONObject json = sr.getJSON("http://106.242.109.54:3000/api/resetpass/chg", params);

 ...
 */
public class PageFragment_diag_dog extends Fragment{
    private static final int ITEM_COUNT = 20;

    private RecyclerView mGridView;
    private List<String> mItemList;

    public static PageFragment_diag_dog createInstance() {
        final PageFragment_diag_dog pageFragment = new PageFragment_diag_dog();
